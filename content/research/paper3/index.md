...
---
<!-- 
##### Figure 1: The game framework to evaluate the opinion leadership of LLMs
<center><img src="colm24_model.png" width="80%"></center>

##### Figure 2: Overview of the data generation process
<center><img src="colm24_WWQA.png" width="80%"></center>

##### Figure 3: Opinion leadership of LLMs under different roles
<center><img src="colm24_role.png" width="80%"></center> -->

<table style="width: 100%; border-collapse: collapse; border: none;">
  <tr style="border: none;">
    <td style="width: 40%; border: none; text-align: left;">
      <h5>Figure 1: The game framework to evaluate the opinion leadership of LLMs</h5>
      <img src="colm24_model.png" width="100%">
    </td>
    <td style="width: 60%; border: none; text-align: left;">
      <h5>Figure 2: Overview of the data generation process</h5>
      <img src="colm24_WWQA.png" width="100%">
    </td>
  </tr>
</table>
<!-- <table style="width: 50%; border-collapse: collapse; border: none;">
  <tr style="border: none;">
    <td style="width: 50%; border: none; text-align: left;">
      <h5>Figure 3: Opinion leadership of LLMs under different roles</h5>
      <img src="colm24_role.png" width="100%">
    </td>
  </tr>
</table> -->
